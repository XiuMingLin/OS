...
public class process {
    ...
    private int Server_time;      //运行时间
    private ArrayList<Integer> Critical_stime_List;       //临界资源开始时间的列表（多次）
    private ArrayList<Integer> Critical_etime_Liat;       //临界资源结束时间的列表（多次）
    int p1_s_time = -1;
    int p1_e_time = -1;
    int p2_s_time = -1;
    int p2_e_time = -1;
    private int IO_stime;             //IO开始时间（多次）
    private int IO_etime;             //IO结束时间（多次）
